...
# use_local_attn = False for 1.Query object feature  
# use_local_attn = True  for 2.Query map feature
...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        # for Query map feature (local attn)
        ...
        # Apply projections here (shape: num_queries x batch_size x 256)
        
        q_content        = self.ca_qcontent_proj(tgt)  # tgt is output of SA
        ...
        print(" detr "); #import pdb; pdb.set_trace()
