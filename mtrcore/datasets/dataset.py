...
import mtrcore.utils.common_utils as common_utils
...
class DatasetTemplate(torch_data.Dataset):
    ...
    def collate_batch(self, batch_list):
        ...
        for key, val_list in key_to_list.items():
            ...
            if key in [
                'obj_trajs', 'obj_trajs_mask', 'map_polylines', 'map_polylines_mask', 'map_polylines_center',
                ...
                'scenario_id', 'obj_types', 'obj_ids', 'center_objects_type', 'center_objects_id'
            ]:
